...
> = {
  aristotle: {
    problem:
      'Reading complex books is challenging. Readers often have questions about context, characters, or concepts, but traditional tools either spoil the story or provide irrelevant information.',
    approach:
      "Built an AI-powered e-reader that understands your current reading position and provides contextual answers without spoilers. Uses a RAG pipeline with metadata-aware retrieval to ensure responses are grounded in only what you've read.",
    features: [
    ...
    techDetails:
      'Next.js frontend with React Server Components, Pinecone for vector storage, OpenAI embeddings, Vercel AI SDK for streaming responses, Firebase for auth and storage. Custom chunking strategy that preserves narrative structure.',
    learnings: [
  ...
  'lyrn-code': {
    problem:
      'Learning to code is often frustrating because feedback is delayed, practice is generic, and tutoring is expensive. Existing platforms don\'t adapt to individual learning patterns.',
    approach:
      'Built an AI tutor that maintains a skills matrix, provides adaptive practice problems, and offers real-time evaluation with personalized feedback. Uses agent-driven tutoring with function calling to provide an interactive learning experience.',
    features: [
    ...
    techDetails:
      'Next.js with TypeScript, LangChain for agent orchestration, OpenAI function calling for structured interactions, Firebase for user data and progress tracking. Custom evaluation pipeline that assesses both correctness and code quality.',
    learnings: [
  ...
  return (
    <article className="mx-auto max-w-3xl px-6 md:px-8 py-20 md:py-28">
      ...
      <header className="mb-12">
        ...
        {project.links.live && (
          <AnimatedLink href={project.links.live} external className="inline-flex items-center gap-2 text-sm font-medium">
            Visit {project.name} →
          </AnimatedLink>
        )}
      </header>
      ...
      {details ? (
        <div className="space-y-12">
          ...
          <section>
            <h2 className="text-2xl font-semibold tracking-tight mb-4">Approach</h2>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">{details.techDetails}</p>
          ...
          <section>
            <h2 className="text-2xl font-semibold tracking-tight mb-4">What I Learned</h2>
            <ul className="space-y-3">
